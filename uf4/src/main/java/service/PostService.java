...
public class PostService {
    ...
    public Usuario newUser(HttpServletRequest request) throws SQLException {
        ...
        if (t != null) {
            respuesta.setAttribute("El nombre ya està cogido", toast);
            throw new SQLException();
        }
    ...
    public boolean createUser(HttpServletRequest request) {
        ...
        try {
            ...
            dao.insertUsuario(u);
            respuesta.setAttribute("Bienvenido" + u.getName(), toast);
            return true;
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    public void createPost(HttpServletRequest request) {
        ...
        try {
            ...
            respuesta.setAttribute("Post creado", toast);
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }
        ...
        try {
            ...
            for (Post p : postUserList) {
                if (p.getId() == idPost) {
                    ...
                    respuesta.setAttribute("Post Borrado", toast);
                }
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
