                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            ...
                            <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                ...
                                <div class="form-floating">
                                    <input class="form-control" id="link" type="tel" placeholder="Ingresa tu cuenta de Red Social" data-sb-validations="required" />
                                    <label for="link">Red Social (Linkdin)</label>
                                    <div class="invalid-feedback" data-sb-feedback="phone:required">Campo requerido.</div>
                                </div>
                                <div class="form-floating">
                                    <textarea class="form-control" id="git" placeholder="Enter your message here..." style="height: 12rem" data-sb-validations="required"></textarea>
                                    <label for="git">GitHub/GitLab</label>
                                    <div class="invalid-feedback" data-sb-feedback="message:required">Campo requerido</div>
                                </div>
                                <br />
